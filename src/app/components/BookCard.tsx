      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-4">
          <Link href={`/book/${book.id}`} className="flex-1 cursor-pointer">
            <button className="bg-blue-200 w-full px-3 py-2 text-sm border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
              View Details
            </button>
          </Link>
          ...
          <button
            ...
            className={`flex-1 px-3 py-2 text-sm rounded-md transition-colors duration-200 ${
              !book.inStock
                ...
                : "bg-purple-600 text-white hover:scale-110 transform transition-transform duration-200"
            }`}
          >
            {showSuccess ? (
